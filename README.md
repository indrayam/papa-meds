...
### For Enlarged Prostrate
1. **Urimax-D** 1 tab before sleep

### For Constipation
1. **Softovac** => Two tablespoons in a glass of water at bedtime every night (if he feels constipated)
2. **Razo-D or Razole-D** => 1 tablet before breakfast on empty stomach every day
...
### Eye dryness
1. *Lubrex DX* eye drops => 1 drops in each eye in the morning and evening

## Medicines that have been STOPPED

Do not include these in Papa's meds going forward.
...
2. **Meropenem** 1gm Injection (8 hourly)
3. **Pantop 40** Injection 10 ML (12 hourly)
4. **Emeset** Injection 4 ML (8 hourly/SOS only when vomiting)
5. **Optineuron** Injection 3 ML
6. **Fenoverin 200mg** => 1 tablet after breakfast and dinner (Stopped on Nov 29th, 2025)

### For Anxiety and Sleep
1. None

### For Constipation
1. *Duphalac (25ml)* => Only if NO Bowel Movement for 2 days
2. **Alkasol Syrup** => 1 tablespoons after breakfast, lunch and dinner daily (Stopped on Dec. 1st, 2025)
3. *Good Bug Smooth Move powder* => 1 satchet in a glass of water at bedtime
